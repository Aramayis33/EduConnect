...
public class EmailSenderService {
    ...
    public boolean sendPasswordToAdmin(String toEmail, String password, JavaMailSender mailSender) {
        try {
            SimpleMailMessage message = new SimpleMailMessage();
            message.setTo(toEmail);
            message.setSubject("EduConnect - գաղտնաբառ");
            message.setText("Ձեր ադմին էջի գաղտնաբառն է: " + password + "\n Օգտագործեք այն ադմինիստրացիոն էջ մուտք" +
                    " գործելու համար, իսկ հետո ըստ ցանկության ստեղծեք նոր գաղտնաբառ:");
            mailSender.send(message);
            return true;
    ...
    public boolean sendAboutEmailChange(String name, String toEmail, JavaMailSender mailSender) {
        try {
            SimpleMailMessage message = new SimpleMailMessage();
            message.setTo(toEmail);
