...
//    default Double findFirstSemesterAverageRatingByStudentAndSubject(Student student, Subjects subject) {
//        Double writtenRatings = findFirstSemesterAverageRatingByStudentAndSubjectAndType(student, subject, "written");
//        Double intermediateRatings = findFirstSemesterAverageRatingByStudentAndSubjectAndType(student, subject, "intermediate");
//        Double currentRatings = findFirstSemesterAverageRatingByStudentAndSubjectAndType(student, subject, "current");
//        double written = (writtenRatings != null) ? writtenRatings : 0.0;
//        double intermediate = (intermediateRatings != null) ? intermediateRatings : 0.0;
//        double current = (currentRatings != null) ? currentRatings : 0.0;
//        double summary = (0.4 * written) + (0.35 * intermediate) + (0.25 * current);
//
//
//        return summary;
//    }
//
//
//    default Double findSecondSemesterAverageRatingByStudentAndSubject(Student student, Subjects subject) {
//        Double writtenRatings = findSecondSemesterAverageRatingByStudentAndSubjectAndType(student, subject, "written");
//        Double intermediateRatings = findSecondSemesterAverageRatingByStudentAndSubjectAndType(student, subject, "intermediate");
//        Double currentRatings = findSecondSemesterAverageRatingByStudentAndSubjectAndType(student, subject, "current");
//
//        double written = (writtenRatings != null) ? writtenRatings : 0.0;
//        double intermediate = (intermediateRatings != null) ? intermediateRatings : 0.0;
//        double current = (currentRatings != null ) ? currentRatings : 0.0;
