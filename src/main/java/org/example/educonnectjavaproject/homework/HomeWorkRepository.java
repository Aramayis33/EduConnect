...
public interface HomeWorkRepository extends JpaRepository<HomeWork, Integer> {
    ...
    @Query("SELECT DISTINCT h FROM HomeWork h " + "JOIN h.fileGroup fg " +
            "JOIN fg.files uf " + "WHERE h.groupNumber = :groupNumber " +
    ...
    @Query("SELECT h FROM HomeWork h " + "LEFT JOIN FETCH h.fileGroup fg " + "LEFT JOIN FETCH fg.files " +
